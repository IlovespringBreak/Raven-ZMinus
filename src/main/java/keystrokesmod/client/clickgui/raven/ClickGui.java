...
public class ClickGui extends GuiScreen {
	...
	public void drawScreen(int x, int y, float p) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Z-", halfScreenWidth + 1 + w_c, quarterScreenHeight + 30, Utils.Client.rainbowDraw(2L, 0L));
        ...
        if (latestVersion.isNewerThan(clientVersion)) {
			...
			FontUtil.normal.drawSmoothString(
		            "Raven Z- v" + clientVersion + " | Config: " + Raven.configManager.getConfig().getName(), 4,
